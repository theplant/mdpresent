...
func cleanEscapeHighlightCode(textBytes []byte, highlight string) (text string) {
...
func parseCode(sourceFile string, sourceLine int, cmd string) (e Elem, err error) {
	...
	textBytes = textBytes[lo:hi]

	text := cleanEscapeHighlightCode(textBytes, highlight)
	...
	e = Code{Text: template.HTML(text), Play: play}
	return
}
